...
API_ID = int(getenv("API_ID", 21993949))
API_HASH = getenv("API_HASH", "e4b320975ddd2640a3beaa315eb2bcb5")
BOT_TOKEN = getenv("BOT_TOKEN", None)
OWNER_ID = int(getenv("OWNER_ID", 6955506263))
MONGO_URL = getenv("MONGO_URL", None)
SUPPORT_GRP = getenv("SUPPORT_GRP", "TrueFriendsFamily")
UPDATE_CHNL = getenv("UPDATE_CHNL", "MightyMirzaBio")
OWNER_USERNAME = getenv("OWNER_USERNAME", "MightyMirza")

# Random Start Images
IMG = [
    "https://te.legra.ph/file/5bf629d10afd4af953585.jpg",
    "https://te.legra.ph/file/7a321b99fe99d9d8b5117.jpg",
    "https://telegra.ph/file/154ba31d810406d54578e.jpg",
